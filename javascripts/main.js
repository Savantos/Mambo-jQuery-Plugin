...
;(function ($, window, undefined) {
	...
	// Start orbit plugin
	$(document.getElementById('showcase')).orbit({
		fluid: '16x5',
		timer: false
	});
	// Mambo demo
	$(document.getElementById('full-features')).mambo({
		value: 65,
		text: {
			label: "Cr",
			displayValue: true,
	...
	$(document.getElementById('only-label')).mambo({
		value: 35,
		text: {
			label: "Ti",
			displayValue: false,
		...
		percentage: {
			drawUnfilled: true,
			color: "#85644E",
			unfilledColor: "#AB9588"
		},
		drawShadow: true
	});
	$(document.getElementById('label-percentage')).mambo({
		value: 65,
		text: {
			label: "",
			displayValue: true,
		...
		internalCircle: {
			fill: 'rgb(109, 172, 212)',
			line: 'rgb(69, 132, 188)'
		},
		percentage: {
			drawUnfilled: true,
			color: "rgb(148, 207, 251)",
